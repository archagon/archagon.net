...
Say you're designing a convergent sequence CvRDT from scratch. Instead of picking an existing sequence CRDT, you've been wickedly tempted by the operational approach of CmRDTs! You wonder if it's possible to take those CmRDT operations and fold them into an efficient CvRDT data structure, giving you the best of both worlds: an ubiquitously-mergable "golden file", plus the flexibility and expressiveness of defining your model in terms of atomic operations.
